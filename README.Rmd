...
[![codecov test coverage](https://codecov.io/gh/ThinkR-open/fusen/branch/main/graph/badge.svg?token=V0HOSAY8WW)](https://codecov.io/gh/ThinkR-open/fusen)
...
_Fill the flat Rmd template with everything in one place and {fusen} will inflate the identified parts in the correct package files and directories._
