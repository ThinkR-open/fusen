...
> If you know how to create a Rmd file, then you know how to build a package.
...
- Run the following code directly in the console to **add the template Rmd** in the project and open it:
```{r, eval=FALSE}
...
- Run the following code to **transform the template Rmd as a package**
