...
# Example dataset
# file.copy(system.file("clients.csv", package = "fusen"), "inst")
# Make your dataset file available to the current Rmd
pkgload::load_all(path = here::here(), export_all = FALSE)
# You will be able to read your data file as follows
datafile <- system.file("clients.csv", package = "<my_package_name>")
clients <- read.csv(datafile)
```
