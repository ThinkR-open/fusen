...
usethis::with_project(dummypackage, {
  ...
  test_that("inflate() worked correctly", {
    ...
    expect_equal(my_median_lines[1], "# Generated by {fusen} from /dev/flat_full.Rmd: DO NOT EDIT BY HAND")
    ...
    expect_equal(my_other_median_lines[1], "# Generated by {fusen} from /dev/flat_full.Rmd: DO NOT EDIT BY HAND")
    ...
    expect_true(all(my_norox_lines == c(
      "# Generated by {fusen} from /dev/flat_full.Rmd: DO NOT EDIT BY HAND", "",
    ...
    donotedit <-grep(
      "<!-- This vignette is generated by \\{fusen\\} from /dev/flat_full.Rmd: DO NOT EDIT BY HAND -->",
      vignette_lines)
