...
- Remember that in the package structure, examples and tests code will be run independantly. Thus, `examples` and `tests` chunk need to have all code required to run independantly.
