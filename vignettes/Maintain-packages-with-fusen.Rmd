...
## Create a new dev_history template

To add a new family of functions, create a new dev_history template

```{r, eval=FALSE}
add_dev_history(name = "add")
```
...
- Run in the Console : `fusen::add_dev_history(name = "add")`
