<!-- do not edit by hand, everything is modified in R and tests files now -->
...
#'
#' @examples
inflate <- function(pkg = ".", rmd = file.path("dev", "dev_history.Rmd"), name = "Get started", check = TRUE, document = TRUE) {
  old <- setwd(pkg)
  on.exit(setwd(old))
...
# fusen::inflate(rmd = file.path("dev", "dev_history_core.Rmd"), name = "How to use fusen", check = FALSE, document = FALSE)
