...
test_that("read_inflate_params works", {
  config_fusen_not_existing <- system.file("tests-templates/fake.yaml", package = "fusen")
  expect_error(
    read_inflate_params(config_fusen = config_fusen_not_existing)
  )

  config_fusen_existing <- system.file("tests-templates/config_fusen_with_inflate_parameters.yaml", package = "fusen")
